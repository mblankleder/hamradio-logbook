...
<html>
    <head>
        ...
        <title><? print $callsign ?> - Amateur Radio Contact Log - Login</title>
    </head>
    <center>
        <h1><? print $callsign ?></h1>
        <h2>Amateur Radio Contact Log</h2>
    </center>
    <body>
        <form method="post" action="login.php">
            <fieldset>
                ...
                <table style="border: none;">
                    ...
                    <tr>
                        <td style="color: #FFF;">Password:</td><td><input type="password" name="password" size="20" maxlength="20"></td>
                    </tr>
                    <tr>
        ...
        <form name="quickSearch" method="post" action="index.php">
            <fieldset>
                ...
                <span style="color: #FFF;">Callsign:&nbsp;<input type="text" name="searchString" maxlength="8"></span>
                    ...
                    <tr class=header>
                        ...
                        <th>Report</th>
                            ...
                            while ($row = mysql_fetch_array($result)) {
                                if ($row_color == 1) {
                                    echo "<tr bgcolor=#EEEEEE><td>" . $row['d'] . " " . $row['t'] . "</td><td>" . $row['station'] . "</td><td>" . $row['band'] . "</td><td>" . $row['frequency'] . "&nbsp;Khz</td><td>" . $row['mode'] . "</td><td>" . $row['operator'] . "</td><td>" . $row['rst_rx'] . "</tr>";
                                    $row_color = "0";
                                } else {
                                    echo "<tr bgcolor=#C3C3C3><td>" . $row['d'] . " " . $row['t'] . "</td><td>" . $row['station'] . "</td><td>" . $row['band'] . "</td><td>" . $row['frequency'] . "&nbsp;Khz</td><td>" . $row['mode'] . "</td><td>" . $row['operator'] . "</td><td>" . $row['rst_rx'] . "</tr>";
                                    $row_color = "1";
                                }
                            }
                            echo "</table>";
